    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                return '<a href="' . route('admin.shipping-rule.edit', $query->id) . '" class="btn btn-outline-primary"><i class="far fa-edit"></i></a>
                <a href="' . route('admin.shipping-rule.destroy', $query->id) . '" class="btn btn-outline-danger delete-item ml-2"><i class="fas fa-trash-alt"></i></a>';
            })
            ...
            ->rawColumns(['action','status' , 'min_cost' , 'type'])
            ->setRowId('id');
    }
