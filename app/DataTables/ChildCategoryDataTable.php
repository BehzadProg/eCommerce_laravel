    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                return '<a href="' . route('admin.child-category.edit', $query->id) . '" class="btn btn-outline-primary"><i class="far fa-edit"></i></a>
                 <a href="' . route('admin.child-category.destroy', $query->id) . '" class="btn btn-outline-danger delete-item ml-2"><i class="fas fa-trash-alt"></i></a>';
            })
