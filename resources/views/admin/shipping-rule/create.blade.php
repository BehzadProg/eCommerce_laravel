                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.shipping-rule.store')}}" method="post">
                            ...
                            <div class="form-group row mb-4 min_cost d-none">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Minimum Amount</label>
                                <div class="col-sm-12 col-md-7">
                                    <input name="min_cost" type="text" value="{{old('min_cost')}}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input name="cost" type="text" value="{{old('cost')}}" class="form-control">
                                </div>
                              </div>
