    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="{{ route('admin.order.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
            </div>
            <h1>Order</h1>
        </div>
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped table-hover table-md">
                        ...
                        @endif
                          ...
                          <td class="text-right">{{$order->currency_icon}}{{($product->unit_price * $product->qty) + ($product->variant_total * $product->qty)}}</td>
                        </tr>
                        @endforeach
                      </table>
                    </div>
