                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="sub_category" class="form-control select2 sub-category">
                                ...
                                <option {{$subCat->id == $productSliderSectionTwo->sub_category ? 'selected' : ''}}  value="{{$subCat->id}}">{{$subCat->name}}</option>
                              @endforeach
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="child_category" class="form-control select2 child-category">
                                ...
                                <option {{$childCat->id == $productSliderSectionTwo->child_category ? 'selected' : ''}}  value="{{$childCat->id}}">{{$childCat->name}}</option>
                                @endforeach
