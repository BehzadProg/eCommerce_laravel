                    ...
                    <div class="col-xl-4 col-lg-5">
                        <div class="wsus__order_details" id="sticky_sidebar">
                            ...
                            <div class="wsus__order_details_summery">
                                ...
                                <p><b>total:</b>
                                    <span><b id="total_amount" data-id="{{getMainCartTotal()}}">{{ $settings->currency_icon }}{{ getMainCartTotal() }}</b></span></p>
                            </div>
                            <div class="terms_area">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="flexCheckChecked3">
                                        I have read and agree to the website <a target="_blank" href="{{route('terms-and-conditions.index')}}">terms and conditions *</a>
                                    </label>
                                </div>
                            </div>
