...
@section('title')
    {{ $settings->site_name }} || Vendor Products Page
@endsection
@section('content')
    <!--============================
            BREADCRUMB START
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <ul>
                            ...
                            <li><a href="{{route('vendor.index')}}">vendors page</a></li>
                            <li><a href="javascript:void(0)">vendor products</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="wsus__pro_page_bammer vendor_det_banner">
                        <img src="{{asset(env('VENDOR_SHOP_PROFILE_BANNER_UPLOAD_PATH').$vendor->banner)}}" alt="banner" class="img-fluid w-100">
                                            ...
                                            <div class="wsus__product_item">
                                                ...
                                                <div class="wsus__product_details">
                                                    ...
                                                    <a class="wsus__pro_name"
                                                        href="{{ route('product-detail', $product->slug) }}"
                                                        target="_blank">{{ limitText($product->name, 55) }}</a>
                                                    @if (checkDiscount($product))
                                                        <p class="wsus__price">
