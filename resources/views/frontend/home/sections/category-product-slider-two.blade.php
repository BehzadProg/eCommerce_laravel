@php
    $sliderSectionTwo = json_decode($productSliderSectionTwo->value);

    $lastKey = [];
    foreach ($sliderSectionTwo as $key => $category) {
        if ($category === null) {
            break;
        }
                ...
                <div class="wsus__product_item">
                    ...
                    <ul class="wsus__single_pro_icon">
                        <li><a href="#" data-bs-toggle="modal"
                                data-bs-target="#exampleModal-{{ $product->id }}"><i class="far fa-eye"></i></a></li>
